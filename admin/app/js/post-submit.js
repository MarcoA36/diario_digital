...
import { validarLongitud, validarCaracteres, validarFormatoImg, validarLongitudPalabra } from "./validations.js";
...
export function submitPost(accion, event) {
    ...
    //TITULO
    let titleValidateLength = validarLongitud(campos.titulo, 10, 50)
    ...
    //ENCABEZADO
    let subtitleValidateLength = validarLongitud(campos.bajada, 50, 120)
    ...
    //CUERPO
    let cuerpoValidateLength = validarLongitud(campos.cuerpo, 300, 3000)
